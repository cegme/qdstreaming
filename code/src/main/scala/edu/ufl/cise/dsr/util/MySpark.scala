...
object MySpark extends MyLogging {
  ...
  lazy val conf:SparkConf = {
    ...
    val conf = new SparkConf()
      ...
      .setMaster("spark://sm321-01.cise.ufl.edu:7077")
      ...
      //.set("spark.executor.memory", "%dg".format(32))
      ...
      .set("spark.executor.extraJavaOptions", "-XX:+UseCompressedOops -XX:+UseCompressedStrings -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+HeapDumpOnOutOfMemoryError")
